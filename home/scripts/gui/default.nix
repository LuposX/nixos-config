    ...
    ''
      ...
      function ui(){
        ...
        apps=(
          ...
          "󰌌;Keybindings;nvim ${configDirectory}/docs/keybindings.md"
          "󰋩;Wallpapers;firefox https://github.com/anotherhadi/nixy-wallpapers"
        )
...
in {
  ...
  xdg.desktopEntries.nixy = {
    name = "Nixy";
    genericName = "NixOS System Manager";
    comment = "A UI wizard to manage the NixOS system";
    exec = "nixy";
    icon = "utilities-terminal"; # Or replace with a custom icon path if you have one
    terminal = true;
