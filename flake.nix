...
#
{
  ...
  outputs = inputs @ { self, nixpkgs, nixos-hardware, home-manager, nixvim, doom-emacs, hyprland, hyprspace, nixcord, ... }: 
    let 
    ...
    in {
        ...
        import ./hosts {
          inherit (nixpkgs) lib;
          inherit inputs nixpkgs nixos-hardware home-manager nixvim doom-emacs hyprland hyprspace nixcord vars; # Inherit inputs
        }
      );
    };
}
